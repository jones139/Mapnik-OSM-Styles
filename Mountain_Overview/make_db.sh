...
wget --timeout=3600 http://jxapi.openstreetmap.org/xapi/api/0.6/map?bbox=-2.29,54.73,-2.00,54.82 -O weardale.osm
#wget --timeout=3600 http://api.openstreetmap.org/api/0.6/map?bbox=-2.29,54.73,-2.00,54.82 -O weardale.osm
