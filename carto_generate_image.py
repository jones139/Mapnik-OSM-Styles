...
if __name__ == "__main__":
    try:
        cartomapfile = os.environ['MAPNIK_MAP_FILE']
    except KeyError:
        cartomapfile = "osm2.mml"
    mapfile = "osm2.xml"
    map_uri = "image.png"

    print "Generating mapnik style file from %s." % (cartomapfile)
    os.system("/home/graham/OSM/code/carto/bin/carto %s > %s" 
              % (cartomapfile,mapfile))
    print "Rendering Map"
